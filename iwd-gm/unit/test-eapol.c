...
void create_eapol_key_data_afl(){
    ...
    struct eapol_key_data_afl *ekda = malloc(sizeof(struct eapol_key_data_afl));
    ekda->frame=  __afl_key;
    ekda->frame_len = __afl_key_len;
    ...
    ekda->key_nonce[0x32, 0x89, 0xe9, 0x15, 0x65, 0x09, 0x4f, 0x32, 0x9a,
            0x9c, 0xd5, 0x4a, 0x4a, 0x09, 0x0d, 0x2c, 0xf4, 0x34,
            0x46, 0x83, 0xbf, 0x50, 0xef, 0xee, 0x36, 0x08, 0xb6,
            0x48, 0x56, 0x80, 0x0e, 0x84 ];
    ekda->eapol_key_iv[0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ];
    ekda->key_rsc [ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ];
    ekda->key_mic_data[0x01, 0xc3, 0x1b, 0x82, 0xff, 0x62, 0xa3, 0x79, 0xb0,
            0x8d, 0xd1, 0xfc, 0x82, 0xc2, 0xf7, 0x68 ];
