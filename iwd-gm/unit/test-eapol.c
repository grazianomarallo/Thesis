...
void * __afl_get_key_data_ptk( ){
    ...
    if (fp == NULL){
        ...
        __afl_key1 =(uint8_t*) eapol_key_data_3;
        __afl_key2= (uint8_t*) eapol_key_data_5;
        __afl_key3= (uint8_t*) eapol_key_data_5;
        len_frame1= sizeof(eapol_key_data_5);
        len_frame2= sizeof(eapol_key_data_5);
        len_frame3= sizeof(eapol_key_data_5);
...
//     assert(verify_step2_called);
  ...
  //  printf("\n Installing a new key in between 2 and 3  \n");
 //__handshake_set_install_tk_func(detect_key_reinstallation);
    ...
    //printf("\n Installing a new key in between 2 and 3 and retransmit 3 \n");
     //__handshake_set_install_tk_func(detect_key_reinstallation);
